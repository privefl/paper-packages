...
knitr::opts_chunk$set(echo = TRUE, fig.align = "center", fig.width = 15)
```
...
) # Previous runs: 42 / 48 / 48 minutes
```

```{r}
# Errors
mean(XNA[indNA] != X[indNA]) # 4.7 / 4.8 / 4.8 %
...
mean(X_beagle[indNA] != X[indNA]) # 3.1 / 4.8 / 4.8 %
