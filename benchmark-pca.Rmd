...
snp_writeBed(celiac, "backingfiles/celiacQC_keep1.bed",
             ind.col = ind.keep)
snp_readBed("backingfiles/celiacQC_keep1.bed", "celiacQC_keep1")

snp_writeBed(celiac, "backingfiles/celiacQC_keep5.bed",
             ind.row = rep(rows_along(G), each = 5),
             ind.col = ind.keep)
snp_readBed("backingfiles/celiacQC_keep5.bed", "celiacQC_keep5")

snp_writeBed(celiac, "backingfiles/celiacQC_keep10.bed",
             ind.row = rep(rows_along(G), each = 10),
             ind.col = ind.keep)
snp_readBed("backingfiles/celiacQC_keep10.bed", "celiacQC_keep10")
```
